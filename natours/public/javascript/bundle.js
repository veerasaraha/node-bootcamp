    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:9090/api/users/updatePassword' : 'http://127.0.0.1:9090/api/users/updateProfile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn-save--password').textContent = 'Updating...'; // get fileds value

              currentPassword = document.getElementById('password-current').value;
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('password-confirm').value; /// making api call to update password
